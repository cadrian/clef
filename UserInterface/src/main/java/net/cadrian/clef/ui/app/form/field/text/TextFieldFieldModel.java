...
class TextFieldFieldModel<T extends Bean> extends SimpleFieldModel<T, String, JTextField> {
	...
	@Override
	public FieldComponent<String, JTextField> createComponent(final T contextBean, final ApplicationContext context)
