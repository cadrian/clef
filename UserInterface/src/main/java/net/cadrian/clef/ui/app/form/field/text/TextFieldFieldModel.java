...
class TextFieldFieldModel<T extends Bean> extends AbstractSimpleFieldModel<T, String, JTextField> {
	...
	TextFieldFieldModel(final String name, final String tab, final FieldGetter<T, String> getter,
			final FieldSetter<T, String> setter, final FieldComponentFactory<T, String, JTextField> componentFactory) {
